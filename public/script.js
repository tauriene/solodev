...
const translations = {
    ru: {
        ...
        header_nav_ready_solutions: 'Готовые решения',
        ...
        footer_copyright: '© 2025—2026 «Nexium» —<br>студия автоматизации бизнеса',
    ...
    en: {
        ...
        header_nav_ready_solutions: 'Ready Solutions',
        ...
        footer_copyright: '© 2025—2026 "Nexium" —<br>business automation studio',
...
function initPageScripts() {
    ...
    initSolutionsTabs();
    applyTranslations(defaultLanguage, { emit: false });
    initShowcaseTilt();
    initBurgerMenu();
    updateMobileServiceLabel();
    ...
    if (!window.__siteLanguageDomSyncBound) {
        window.__siteLanguageDomSyncBound = 'true';
