      ...
      <header id="site-header">
        <div className="header-inner">
            ...
            <nav className="header-nav" aria-label="Main navigation">
                ...
                <a href="https://t.me/your_telegram" target="_blank" rel="noreferrer" className="nav-link nav-link--tg unbounded">
      ...
      <div className="mobile-menu" id="mobile-menu" aria-hidden="true">
        <div className="mobile-menu-inner">
            <nav className="mobile-menu-nav">
                ...
                <a href="https://t.me/your_telegram" target="_blank" rel="noreferrer" className="mobile-menu-link mobile-menu-link--tg">
                    <span data-i18n="header_telegram">Telegram</span>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <line x1="5" y1="12" x2="19" y2="12"></line>
                        <polyline points="12 5 19 12 12 19"></polyline>
