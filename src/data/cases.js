...
export const casesCatalog = [
  ...
  },
  {
    ...
    titleRu: 'Telegram Mini App для шопа в Архангельске',
    titleEn: 'Telegram Mini App for a shop in Arkhangelsk',
    summaryRu: 'повторных заказов через Telegram',
    summaryEn: 'repeat orders through Telegram',
    detailsRu:
      'Что внутри: каталог товаров, страница товара, корзина и быстрый сценарий оформления заказа внутри Telegram Mini App для локального шопа.',
    detailsEn:
      'Inside: a product catalog, product page, cart, and a fast checkout flow inside a Telegram Mini App for a local shop.',
    tagsRu: ['Telegram', 'Mini App', 'Retail', 'Shop'],
    tagsEn: ['Telegram', 'Mini App', 'Retail', 'Shop'],
    metricRu: '+19%',
    metricEn: '+19%',
